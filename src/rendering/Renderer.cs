...
public class Renderer
{
    ...
    /// </summary>
    public static void Setup(out IntPtr window, out IntPtr renderer)
    {
    ...
    public static void Render(IntPtr renderer)
    {
        ...
        // DEBUG: Showthe deltatime
        DisplayText(renderer, $"Deltatime: {DoomNET.deltaTime:0.###}", 0, 200, 25);
        
        // DEBUG: Display the player's position & velocity
        DisplayText(renderer, $"Player pos: {DoomNET.file.entities[0].position}", 0, 300, 25, y: 720 - 25);
        DisplayText(renderer, $"Player vel: {DoomNET.file.entities[0].GetVelocity()}", 0, 300, 25, y: 720 - 50);
    ...
    /// </summary>
    public static void DisplayText(IntPtr renderer, string text, int fontIndex, int width, int height, int pt = 17, int x = 0, int y = 0)
    {
    ...
    /// </summary>
    public static void CleanUp(IntPtr window, IntPtr renderer)
    {
