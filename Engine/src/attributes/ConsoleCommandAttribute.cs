...
/// <br/>
/// To allow for argumented console commands, use a <see cref="List{T}"/> with <see langword="object"/> as its type.<br/>
...
/// Those commands are mainly for toggleable options or for otherwise visual options (e.g. displaying all commands (<see cref="ConsoleManager.DisplayCommands()"/>) or other values).
/// </summary>
